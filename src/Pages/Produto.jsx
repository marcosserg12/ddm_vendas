...
export default function Produto() {
  ...
  const { data: product, isLoading: isLoadingProduct } = useQuery({
    ...
    queryFn: async () => {
      ...
      return (
        list.find((p) => String(p.id_produto) === String(productId)) || null
      );
    },
    enabled: !!productId,
  });
  ...
  const { data: productImages = [] } = useQuery({
    ...
    queryFn: () =>
      __ddmDatabase.entities.ProdutoImagens.listByProduct(productId),
    enabled: !!productId,
  });
  ...
  const compatibleModels = useMemo(() => {
    ...
    const ids =
      typeof product.modelos_ids === "string"
    ...
    return (
      <div className="min-h-screen py-20 bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Button asChild className="mt-6 bg-orange-500">
    ...
    <div className="bg-white min-h-screen pb-32 md:pb-12 font-sans">
      ...
      <div className="border-b bg-gray-50/50 sticky top-0 z-40 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4 flex items-center justify-between">
          <Link
            to="/catalogo"
            className="flex items-center text-[9px] md:text-[10px] font-black uppercase tracking-widest text-gray-500 hover:text-orange-600 transition-colors"
          >
            <ArrowLeft className="w-3 h-3 md:w-4 md:h-4 mr-2" />{" "}
            <span className="hidden md:inline">Voltar para Peças</span>
            <span className="md:hidden">Voltar</span>
          </Link>
          <Badge
            variant="outline"
            className="border-gray-200 text-gray-400 font-black uppercase text-[8px] md:text-[9px] tracking-widest"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-8">
          ...
          <div className="space-y-4">
            ...
            <div className="hidden md:flex bg-gray-900 text-white p-6 rounded-3xl items-center gap-4 shadow-xl shadow-gray-200">
              ...
              <p className="text-[10px] font-bold uppercase leading-relaxed tracking-tight text-gray-300">
                Esta peça é produzida seguindo rigorosos padrões de dureza e
          ...
          <div className="flex flex-col">
            <div className="mb-6 md:mb-8">
              <div className="flex flex-wrap items-center gap-2 md:gap-3 mb-3 md:mb-4">
                <Badge className="bg-orange-500 text-white font-black italic tracking-tighter rounded-lg text-[9px] md:text-xs">
                  DDM ORIGINAL
                </Badge>
              ...
              <div className="mt-4 mb-4">
                ...
                {compatibleModels.length > 0 ? (
                  ...
                  <Badge
                    variant="outline"
                    className="text-gray-400 border-dashed border-gray-300 py-2 px-4 rounded-xl text-xs"
                  >
            ...
            <div className="bg-gray-50 p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] border-2 border-gray-100 mb-6 md:mb-8">
              <ProductPrice
                ...
                size="lg"
              />
              <p className="text-[8px] md:text-[9px] font-black text-gray-400 uppercase tracking-widest mt-3 md:mt-4">
                Venda sujeita a disponibilidade de estoque técnico
              </p>
            </div>
            ...
            <div className="hidden lg:block space-y-4">
              {inStock ? (
                ...
                <Badge className="bg-red-50 text-red-600 p-4 rounded-xl border-none font-black uppercase text-center w-full">
        ...
        <div className="mt-12 md:mt-20">
          <div className="flex items-center gap-4 mb-6 md:mb-8">
            ...
            <h2 className="text-lg md:text-xl font-black uppercase italic tracking-tighter text-gray-900">
              Ficha <span className="text-orange-500">Técnica</span>
            </h2>
            <div className="h-px bg-gray-100 flex-1" />
          </div>
...
function TrustBadge({ icon: Icon, label }) {
  return (
    <div className="flex flex-col items-center p-3 md:p-4 bg-gray-50 rounded-xl md:rounded-2xl border border-transparent hover:border-gray-100 transition-colors">
      ...
      <span className="text-[8px] md:text-[9px] font-black uppercase tracking-tight text-gray-400 text-center leading-tight">
        {label}
      </span>
    </div>
  );
